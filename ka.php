...
ulang:
// function change(){
echo "\e[93m!!===========KAGURA  OYE===========!! \n";
echo "\e[32m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[32m         SCRIFT GOJEK AGUSTUS       \n";
echo "\e[93m  ======================================\n";
echo "\e[93m       \e[32m AUTO CLAIM VOCHER 15K \e[93m \n";
echo "\e[93m  =====================================\n";
echo "\e[32m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
        $nama = nama();
        ...
        echo color("yellow","\n=========UPDATE AGUSTUS=============");
        echo "\n".color("green"," [Food] VOC GOFOOD ");
        echo "\n".color("yellow","▶SabarYa");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(35);
        }
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PESENGOFOOD2107"}');
	...
	$post = [
         ...
         echo color("red","[+] PIN GOPAY KAMU 168168 ")."\n";
         $data2 = '{"pin":"169168"}';
