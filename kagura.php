...
echo "\e[7m\e[31m \e[0m"."\e[7m\e[34m\e[5m            \e[0m"."\e[7m\e[36m\e[1m :✧: \e[0m"."\e[7m\e[34m\e[5m ☆KA\e[0m"."\e[7m\e[34m\e[5mGUR\e[0m"."\e[7m\e[34m\e[5mAAA☆ \e[0m"."\e[7m\e[36m\e[1m :✧: \e[0m"."\e[7m\e[34m\e[5m            \e[0m"."\e[7m\e[31m \e[0m\n";
...
$token = $accesstoken; 
         ...
         echo "\e[7m\e[36m\e[1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\e[0m"."\e[7m\e[36m\e[1m PIN\e[0m"."\e[7m\e[36m\e[1m KAMU..168168 ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\e[0m\n";
         $data2 = '{"pin":"168168"}';
...
or$r_1872009285==18 or$r_1872009285==14 or$r_1872009285==11 or$r_1872009285==8 or$r_1872009285==4 or$r_1872009285==1){echo$u_4200126041."";}if($r_1872009285==0){echo$u_4200126041."";echo "";}sleep(1);
        ...
        $code1 = request2('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAGOFOOD1908"}');
        $message = fetch_value($code1,'"message":"','"');
        if(strpos($code1, 'Promo kamu sudah bisa dipakai')){
        echo  "\n".("\e[7m\e[32m ".$message)." \e[0m\n";
        goto gofood2;
